 ...
 */
const sendDriverOtpEmail = async (email, otp, context = 'login') => {
    if (!resend) {
        console.warn('⚠️  Email not sent: RESEND_API_KEY is not configured');
        return false;
    }
...
exports.sendDriverOtpEmail = sendDriverOtpEmail;
...
exports.sendDriverDocumentsNotificationEmail = sendDriverDocumentsNotificationEmail;
...
exports.sendGoaMilesRideEmail = sendGoaMilesRideEmail;
...
exports.sendShankhContactEmails = sendShankhContactEmails;
...
exports.sendShankhContactEmailsWithTextFallback = sendShankhContactEmailsWithTextFallback;
